...
//@BeforeClass
	...
	@BeforeTest
	public void browsersetUp(@Optional("chrome") String browserName) throws InterruptedException, IOException {
		...
		sf.assertNotEquals(actualURl, currentUrl);
